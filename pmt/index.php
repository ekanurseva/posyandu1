...
$pmt = query("SELECT * FROM pmt ORDER BY idjadwal ASC");
?>
    ...
    <div class="main-container m-0">
        <div class="d-flex">
            ...
            <div class="contents">
                ...
                <div class="mt-4">
                    <a class="btn btn-primary" href="input.php">
                        Tambah Data
                    </a>
                </div>
                        ...
                        <tbody>
                            ...
                            foreach ($pmt as $p):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="text-decoration-none" href="edit.php?id=<?= enkripsi($p['idpmt']); ?>">
                                            <button class="btn btn-sm btn-primary"><i
                                                    class="bi bi-pencil-fill"></i></button>
                                        </a>
                                        |
                                        <a class="delete bg-danger" id="delete" onclick="deletePMT(<?= $p['idpmt']; ?>)">
