...
if (isset($_POST['id_posyandu'])) {
    $id_posyandu = $_POST['id_posyandu'];

    $posyandu = query("SELECT * FROM posyandu WHERE id_posyandu = $id_posyandu")[0];
} else {
    echo "<script>
    ...
    <div class="main-container m-0">
        <div class="d-flex">
            ...
            <div class="contents">
                ...
                <h5 class="text-center mt-4">DI POSYANDU
                    <?= strtoupper($posyandu['nama_posyandu']); ?>
                </h5>

                <form method="post" action="">
                    <input type="hidden" name="id_user" value="<?= $user['id_user']; ?>">
                    <input type="hidden" name="id_posyandu" value="<?= $_POST['id_posyandu']; ?>">

                    <div class="mb-3 mt-5 row ms-5">
                        <label for="ibu" class="col-sm-3 me-0 col-form-label">Nama Ibu</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" style="border: 1px solid black;" id="ibu"
                    ...
                    <div class="mb-3 mt-2 row ms-5">
                        ...
                        <div class="col-sm-6">
                            <select class="boxc form-control" style="border-color: black;" name="idposyandu" require
                                id="posyandu">
                                <option selected value="<?= $posyandu['id_posyandu']; ?>"><?= $posyandu['nama_posyandu']; ?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-2 me-0">
                            <a href="balita.php" class="btn btn-secondary">
                                Kembali
                            </a>
                        </div>
