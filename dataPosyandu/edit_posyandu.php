...
$id = dekripsi($_GET['id']);
$data = query("SELECT * FROM posyandu WHERE id_posyandu = $id")[0];
?>
        ...
        <div class="d-flex">
            ...
            <div class="contents">
                ...
                <form method="post" action="">
                    ...
                    <input type="hidden" name="oldnama" value="<?= $data['nama_posyandu']; ?>">
                    ...
                    <div class="mb-3 mt-5 row ms-5">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" style="border: 1px solid black;" id="posyandu"
                                name="nama_posyandu" value="<?= $data['nama_posyandu']; ?>">
                        </div>
                    </div>
                    <div class="mb-5 mt-2 row ms-5">
                        ...
                        <div class="col-sm-6">
                            <textarea type="text" style="border-color: black;" class="form-control" id="alamat" rows="6"
                                name="alamat_posyandu"><?= $data['alamat_posyandu']; ?></textarea>
                        </div>
                    </div>
...
if (isset($_POST['submit'])) {
    if (update($_POST) > 0) {
        $_SESSION["berhasil"] = "Data Posyandu Berhasil Diubah!";
        echo "
            <script>
