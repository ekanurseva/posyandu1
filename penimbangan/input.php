        ...
        <div class="d-flex">
            ...
            <div class="contents">
                ...
                <form method="post" action="">
                    ...
                    <div class="mb-3 mt-2 row ms-5">
                        <label for="bb" class="col-sm-3 me-0 col-form-label">Berat Badan (kilogram)</label>
                        <div class="col-sm-6">
                            <input type="number" step="0.01" class="form-control" style="border: 1px solid black;"
                                id="bb" name="berat_badan">
                        </div>
                    </div>
...
if (isset($_POST['submit'])) {
    if (create($_POST) > 0) {
        $_SESSION["berhasil"] = "Data Penimbangan Berhasil Ditambahkan!";
        echo "
            <script>
        ...
        echo "
          <script>
              Swal.fire(
                'Gagal!',
                'Data Penimbangan Gagal Ditambahkan!',
                'error'
            )
          </script>
      ";
