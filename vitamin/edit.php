...
if (isset($_GET['id']) && isset($_POST['url'])) {
    $id_vitamin = dekripsi($_GET['id']);

    $data = query("SELECT * FROM vitamin WHERE id_vitamin = $id_vitamin")[0];
        ...
        <div class="d-flex">
            ...
            <div class="contents">
                ...
                <form method="post" action="">
                    ...
                    <div class="mb-3 mt-2 row ms-5">
                        <label for="jenis" class="col-sm-3 me-0 col-form-label">Jadwal Vitamin</label>
                        <div class="col-sm-6">
                            <select class="boxc form-control" style="border-color: black;" name="jenis_vitamin" require
                                ...
                                <?php foreach ($vitamin_array as $vit): ?>
                                    <option value="<?= $vit ?>" <?= $vit == $data['jenis_vitamin'] ? "selected" : ""; ?>><?= $vit; ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div>
...
if (isset($_POST['submit'])) {
    if (update($_POST) > 0) {
        $_SESSION["berhasil"] = "Data Vitamin Berhasil Diubah!";
        echo "
            <script>
