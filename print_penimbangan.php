    ...
    foreach ($data_posyandu as $posyandu) {
        ...
        if ($jadwal_posyandu) {
            ...
            foreach ($jadwal_posyandu as $jadwal) {
                ...
                $cek_jadwal = query("SELECT * FROM penimbangan WHERE idjadwal = '$idjidwil'");
                ...
                if (count($cek_jadwal) != 0) {
                    ...
                    $html .= '<h5 style="margin-top: 7px;">Tidak ada balita yang melakukan penimbangan pada posyandu ' . $nama_posyandu . ' di bulan ini</h5><br>';
                }
