...
if (isset($_GET['cek_tanggal']) && ($_GET['dari'] != "" && $_GET['sampai'] != "")) {
    ...
    $imunisasi = query("SELECT * FROM imunisasi ORDER BY id_balita ASC");
}
?>
...
<body>
    ...
    <div class="main-container m-0">
            ...
            <div class="contents">
                ...
                <div class="mt-4">
                    <div class="row justify-content-between">
                        <div class="col-4">
                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#imun">
                                Tambah Data
                            </button>
                        </div>
                        <div class="col-4">
        ...
        <div class="modal fade" id="imun" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <script>
        ...
        document.getElementById('submitBtn').addEventListener('click', function () {
            ...
            var url = '../print_imunisasi.php?bulan=' + bulan + '&tahun=' + tahun;
